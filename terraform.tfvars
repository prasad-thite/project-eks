...
private_subnet_k8s_cidr = ["10.0.2.0/24", "10.0.3.0/24"]
private_subnet_db_cidr  = ["10.0.4.0/24", "10.0.5.0/24"]
availability_zones      = ["us-east-2a", "us-east-2b"]

#IAM
eks_cluster_role_name   = "eks_cluster_role"
eks_cluster_role_arn    = "arn:aws:iam::451382472143:role/eks_cluster_role"
# cluster_policy_arn      = "arn:aws:iam::aws:policy/AmazonEKSClusterPolicy"
# role_arn              =  "arn:aws:iam::aws:policy/AmazonEKSClusterPolicy"
eks_nodegroup_role_arn  =  "arn:aws:iam::451382472143:role/nodegroup_role"
eks_nodegroup_role_name = "nodegroup_role"
# node_group_policy_arn         = "arn:aws:iam::451382472143:role/aws-service-role/eks-nodegroup.amazonaws.com/AWSServiceRoleForAmazonEKSNodegroup"
